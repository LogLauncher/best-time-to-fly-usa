...
As I am a person that travels by air fairly often and was thinking of planning a trip around the USA I was wanting to see what might influence travels.

An important piece of information I was wanting to know was, what type of weather can cause flights to be late.<br>
While I was at it I can also confirm whether the weather has an impact on flights being late.

## Methods

### Where I got the data

As the trip, I'm going to plan is in the USA, which is a big place, I will travel by plane quite a bit. So I needed information on past flights, the weather condition on those days and a list of all the US states, just in case.
...
- Ruby scripts: They were used to format the data, remove the unwanted columns & rows and even combine some rows.
...
1. Why were there a lot of delays in March but not too many storms?
2. What happened in June?
3. Why does it suddenly jump back up in December?

With the following three charts I could see what caused this to happen.

| Storm types for specific months
| --------------------------------------------------------------------------------------------
| ![Storm types for a specific month](../figures/final/Storm_type_for_certain_months-Good.png)

From these charts, we can see that the winter weathers (storm, snow and weather) have a lot of influence on flight delays.<br>
...
Unfortunately, we can not see how long the delay was. If the delay was only a couple of minutes this wouldn't really matter but if the delay was a couple of hours then that's a problem.
